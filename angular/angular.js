/**
 * @license AngularJS v1.3.0-local+sha.635cdaa
...
function minErr(module) {
  return function () {
    ...
    message = message + '\nhttp://errors.angularjs.org/1.3.0-local+sha.635cdaa/' +
      (module ? module + '/' : '') + code;
 ...
 */
var version = {
  full: '1.3.0-local+sha.635cdaa',    // all of these placeholder strings will be replaced by grunt's
